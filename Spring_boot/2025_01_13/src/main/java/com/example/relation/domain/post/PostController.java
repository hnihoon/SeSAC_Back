...
public class PostController {
    ...
    @PostMapping("/{id}/tags")
    public void addTagPost(@PathVariable Long id,
...
//    }
    ...
    public ResponseEntity<ApiResponse<List<PostWithCommentResponseDtoV2>>> readPostsWitchCommentPage(Pageable pageable){
        return ResponseEntity.ok(ApiResponse.ok(
